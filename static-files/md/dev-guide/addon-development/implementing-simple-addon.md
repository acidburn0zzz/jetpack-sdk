...
Add-on SDK's [`self`](/packages/api-utils/docs/self) module.
...
* [`context-menu`](/packages/addon-kit/docs/context-menu) enables add-ons to
add new items to the context menu

* [`request`](/packages/addon-kit/docs/request) enables add-ons to make
network requests

* [`selection`](/packages/addon-kit/docs/selection) gives add-ons access to
...
[Globals](/dev-guide/addon-development/globals) reference section.
...
[Program ID](/dev-guide/addon-development/program-id) document.
...
[CommonJS](/dev-guide/addon-development/commonjs), which provides the infrastructure
for the SDK.